...
CREATE TABLE `users` (
  ...
  `register_ip` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '注册时的ip',
  `login_ip` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '登录时的ip',
  `last_login_time` int(11) unsigned NOT NULL DEFAULT 0 COMMENT '最近登录的时间（秒级时间戳）',
